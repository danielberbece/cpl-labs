...
REAL : (DIGITS FRACTION | FRACTION) EXPONENT;
...
BLOCK_COMMENT_OPEN: '/*' -> pushMode(IN_COMMENT), more;

mode IN_COMMENT;
BLOCK_COMMENT_OPEN2: '/*' -> pushMode(IN_COMMENT), more;

BLOCK_COMMENT_EOF: . EOF {System.out.println("EOF in comment");};

...
public class Test {
    ...
    public static void task12() throws IOException {
        ...
        var listener = new CPLangParserBaseListener() {
		     ...
		     */
				...
				@Override
				public void exitMethoddef(CPLangParser.MethoddefContext ctx) {
					super.exitMethoddef(ctx);
					funcDefs++;
				}
    ...
    public static void task3() throws IOException {
		...
		var visitor = new CPLangParserBaseVisitor<Integer>() {
			...
			@Override
			public Integer visitMultiply(CPLangParser.MultiplyContext ctx) {
				// TODO Auto-generated method stub
				//return super.visitMultiply(ctx);
				Integer mulInteger = 1;
				for(var expr: ctx.expr()) {
					mulInteger *= visit(expr);
				}
			...
			@Override
			public Integer visitDivide(CPLangParser.DivideContext ctx) {
				// TODO Auto-generated method stub
